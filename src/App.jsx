...
Output the result in clean, well-formatted markdown. Focus on accuracy and readability.`,
      ...
      const response = await fetch('http://135.224.195.180:11434/api/chat', {
        method: 'POST',
        headers: {
                ...
                <div className="glass-panel p-6">
                  <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="gradient-border">
                        <div className="glass-panel whitespace-pre-wrap font-mono text-sm p-4 rounded-xl overflow-auto max-h-[400px] leading-relaxed">
                          <ReactMarkdown>
                            {currentResult.text}
                          </ReactMarkdown>
                        </div>
                      ...
                      <div className="glass-panel p-4">
                        <div className="flex flex-col lg:flex-row gap-6">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="gradient-border">
                              <div className="glass-panel whitespace-pre-wrap font-mono text-sm p-4 rounded-xl overflow-auto max-h-[200px] leading-relaxed">
                                <ReactMarkdown>
                                  {item.text}
                                </ReactMarkdown>
                              </div>
